...
const variantClasses: Record<BadgeVariant, string> = {
  ...
  outline: 'bg-transparent text-slate-400 border border-navy-border',
}
...
export function Badge({ variant = 'teal', children, className }: BadgeProps) {
  return (
    <span
      className={cn(
        'inline-flex items-center gap-1.5 rounded-full px-3 py-1 font-mono text-xs tracking-widest uppercase',
